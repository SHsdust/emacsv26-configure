...
(when (version< emacs-version "24.5")
  (message "Your Emacs is old, d some functionality in this config will be disabled. Please upgrade if possible."))
...
;;start company-mode in all buffers
